...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(this, "Настройки открыты (В разработке)", Toast.LENGTH_SHORT).show();
            return true;
        } else if (id == R.id.open) {
            Toast.makeText(this, "Выберите любимую капибару (В разработке)", Toast.LENGTH_SHORT).show();
            return true;
        } else if (id == R.id.save) {
            Toast.makeText(this, "Выберите не любимую капибару (В разработке) ", Toast.LENGTH_SHORT).show();
            return true;
        } else {
